...
package guia6_ejercicio03_extra;

import guia6_ejercicio03_extra.Entidades.Raices;
 ...
 * @author mateo
 */
public class Guia6_Ejercicio03_EXTRA {
    ...
    public static void main(String[] args) {
        ...
        Raices raiz1 = new Raices(leer.nextInt(),leer.nextInt(),leer.nextInt());
